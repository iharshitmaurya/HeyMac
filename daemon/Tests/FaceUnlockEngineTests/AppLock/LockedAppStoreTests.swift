...
@Test func blacklistProtectsRecoveryToolsAndItself() {
    ...
    #expect(AppLockBlacklist.isProtected("com.faceunlock.app", ownBundleID: "com.faceunlock.app"))
    #expect(!AppLockBlacklist.isProtected("com.apple.MobileSMS", ownBundleID: "com.faceunlock.app"))
}
